// This widget pops up on the admin UI to prompt the user to finish their Stripe account onboarding
...
const StripeOnboardingWidget = () => {
    ...
    if (!store.metadata.stripe_onboarding_url) {
        return null }
            ...
            <div className="flex items-center gap-4">
                ...
                <div className="space-1.5">
                    ...
                    <p className="text-sm text-grey-50">
                        Activate your account to start selling your products.
                    </p>
                </div>
            </div>
