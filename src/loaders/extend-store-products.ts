...
export default async function (): Promise<void> {
    ...
    Object.assign(module, {
        ...
        defaultStoreProductsFields: [...module.defaultStoreProductsFields, 'store_id', 'featured'],
        allowedStoreProductsRelations: [...module.allowedStoreProductsRelations, 'store'],
        allowedStoreProductsFields: [...module.allowedStoreProductsFields, 'store_id', 'featured'],
    })
}
