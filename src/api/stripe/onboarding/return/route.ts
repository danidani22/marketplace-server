// This is a custom API endpoint that redirects user back to the admin dashboard once they finish with the Stripe onboarding
...
export async function GET(req: MedusaRequest, res: MedusaResponse) {
    ...
    if (!stripeAccount.details_submitted || !stripeAccount.payouts_enabled) {
        ...
        res.redirect(process.env.ADMIN_CORS)
        return
    }
